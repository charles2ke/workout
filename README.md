...
- **API settings** — each source has an "API settings" panel for your OAuth client ID, plus optional token endpoint and API base overrides so you can point at your own CORS-enabled proxy when a provider blocks direct browser calls
